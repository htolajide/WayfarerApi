...
const { Users } = _models.default;
const _default = {
  signup: (function () {
    const _signup = _asyncToGenerator(
    /* #__PURE__ */
      regeneratorRuntime.mark(function _callee(req, res) {
        let _req$body; let firstname; let lastname; let email; let password; let foundUser; let user; let
          token;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                foundUser = Users.list.find(user => user.email === email);
  ...
  login: (function () {
    const _login = _asyncToGenerator(
    /* #__PURE__ */
      regeneratorRuntime.mark(function _callee2(req, res) {
        let _req$body2; let email; let password; let foundUser; let match; let
          token;
